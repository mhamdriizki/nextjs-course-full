...
// Offset pagination — cocok untuk halaman bernomor (page 1, 2, 3...)
...
// Cursor pagination — cocok untuk infinite scroll / load more
...
// Transaction — create post + notifikasi ke semua followers author, atomic
