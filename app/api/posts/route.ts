...
export async function POST(req: NextRequest) {
  ...
  if (!validated.success) {
    // Kalau body bukan object sama sekali (null, array, string, dst),
    // pesannya nyasar ke formErrors, bukan fieldErrors — fieldErrors bisa
    // kosong walau ada error. Sertakan dua-duanya biar konsumen API selalu
    // dapat informasi, apa pun bentuk body yang salah.
