...
export async function PATCH(
  ...
  try {
    ...
    return NextResponse.json({ error: "Update failed or Post not found" }, { status: 404 });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    // we'll do hard delete based on the slide for simplicity, or soft delete since DB has deletedAt
